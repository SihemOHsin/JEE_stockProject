...
<body>
    ...
    <form action="AddArticleController" method="post">
        <label for="nom">Name:</label>
<input type="text" id="nom" name="nom" value="<%= (request.getAttribute("nom") != null) ? request.getAttribute("nom") : "" %>" required><br><br>

        <label for="quantite">Quantity:</label>
        <input type="number" id="quantite" name="quantite" value="<%=request.getAttribute("quantite")%>" required><br><br>
